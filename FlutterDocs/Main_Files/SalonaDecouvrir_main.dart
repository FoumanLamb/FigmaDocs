      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            SizedBox(width: 13.w,),
            Text("Salon à découvrir",style: TextStyle(fontSize: 14.sp,fontWeight: FontWeight.w900),),
            SizedBox(width: 10.w,),
            Text("Salon pour toi",style: TextStyle(fontSize: 13.sp,),),
            SizedBox(width: 25.w,),
            SizedBox(
              height: 40.r,
              width: 40.r,
